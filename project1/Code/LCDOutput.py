...
if __name__ == '__main__':
    ...
    LCD1602.init(0x27, 1)
    printOnLCD("Welcome to      ", "    Project 2   ")
    time.sleep(3)
        ...
        try:
            while True:
                ...
                while True:
                    ...
                    if (isButPressed(butState[0], preButState[0]) and (p == state.chooseCur or p == state.chooseHis)):
                        if p == state.chooseCur:
                            ...
                            printOnLCD("Current        <", "History         ")
                            p = state.chooseCur
                    elif (isButPressed(butState[1], preButState[1]) and (p == state.chooseCur or p == state.chooseHis)):
                        if p == state.chooseCur:
                        ...
                        if (timCur == 3):
                            ...
                            timCur += 1
                            showTime(tim, timCur)
                    elif isButPressed(butState[1], preButState[1]) and p == state.curIsChoosed:
                        break
